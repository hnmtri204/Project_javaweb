    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="CategoryServlet?categoryId=2" class="stext-107 cl7 hov-cl1 trans-04">
                            Women
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="CategoryServlet?categoryId=3" class="stext-107 cl7 hov-cl1 trans-04">
                            Men
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="CategoryServlet?categoryId=6" class="stext-107 cl7 hov-cl1 trans-04">
                            Shoes
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="CategoryServlet?categoryId=10" class="stext-107 cl7 hov-cl1 trans-04">
                            Watches
                        </a>
                    </li>
                </ul>
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                <script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i
                    ...
                    target="_blank">hnmtri</a> &amp; distributed by <a href=""
                    target="_blank">Cazastore</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
